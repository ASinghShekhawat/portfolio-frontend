    ...
    return (
        ...
        className='relative w-full md:h-screen text-white h-unset'>
            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg'>
                    ...
                    <p className="mb-4 py-6">Bringing 2+ years of full-stack engineering from Bangalore, India — I architect backend systems, shape up UIs, and ensure smooth landings in production. Strong in DSA, stronger in getting things done.
                    </p>

                    <p>With a blend of creativity, attention to detail, and determination, I’ve found my passion in crafting web applications. The tech world constantly inspires me, and I’m excited to turn bold ideas into real, meaningful projects.</p>
